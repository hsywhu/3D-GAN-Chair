...
class Generator( nn.Module ):
    def __init__( self, d=16 ):
        ...
        self.deconv1 = nn.ConvTranspose3d( opt.latent_dim, d * 8, 4, 3, 0 )
        ...
        self.deconv5 = nn.ConvTranspose3d( d * 2, 1, 4, 2, 1 )
...
class Discriminator( nn.Module ):
    ...
    def __init__( self, d=16 ):
        ...
        self.conv1 = nn.Conv3d( 1, d, 4, 2, 3 )
        ...
        self.conv4 = nn.Conv3d( d * 2, d * 8, 4, 2, 1 )
...
def main():
    ...
    minst_dataset = MinstDataset( opt.train_csv, opt.train_root)
    ...
    for epoch in range( opt.n_epochs ):
        ...
        for i, ( imgs, _ ) in enumerate( dataloader ):
            ...
            #                                                 opt.latent_dim ) ) ) )
            z = Variable(Tensor(np.random.normal(0, 1, (imgs.shape[0], opt.latent_dim, 1, 1, 1))))
            ...
            if batches_done % opt.sample_interval == 0:
                np.save('images/%d.npy' % batches_done, gen_imgs.detach().cpu())
